...
class _TravelDetailsScreenState extends State<TravelDetailsScreen> {
  ...
  Future<void> _submitTravelDetails() async {
    ...
    try {
      final retreatService = Provider.of<RetreatService>(
  ...
  // Updated _buildTextField with an optional onChanged parameter.
                  ...
                  _buildFormCard(
                    ...
                    [
                      ...
                      _buildTextField(
                        ...
                        icon: _arrivalMethod == 'PLANE' ? Icons.flight : Icons
                            .train,
                      ),
                      _buildTextField(
                        label: "Arrival Date",
                  ...
                  _buildFormCard(
                    ...
                    [
                      ...
                      _buildTextField(
                        ...
                        hintText: "Leave blank if not applicable",
                        icon: _departureMethod == 'PLANE' ? Icons.flight : Icons
                            .train,
                      ),
                      _buildTextField(
                  ...
                  _buildFormCard(
                    ...
                    [
                      _buildTextField(
                        ...
                        onChanged: (value) =>
                            setState(() {}), // Updates the counter in real time
                      ),
                      Align(
